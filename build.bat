...
:: 编译 (添加 --clean 参数清理缓存)
echo [2/3] 正在编译，请稍候...
.venv\Scripts\python.exe -m PyInstaller --clean --onefile --windowed --icon=icon.ico --name="VCT_Display" --add-data="assets;assets" --add-data="icon.jpg;." --add-data="LICENSE;." main.py
